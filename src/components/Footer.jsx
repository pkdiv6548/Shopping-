...
export default function Footer(){return <footer className="site-footer">
 ...
 <div className="footer-grid">
  ...
  <div><b>Help</b><Link to="/support">Help centre</Link><Link to="/faq">FAQ</Link><Link to="/track-order">Track order</Link><Link to="/returns">Returns</Link><Link to="/shipping-policy">Shipping</Link><Link to="/contact">Contact us</Link></div>
